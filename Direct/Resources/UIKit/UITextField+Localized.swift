...
extension UITextField {
    ...
    public func attributedPlaceholder(title: String) {
        ...
        attributesStr.addAttribute(NSAttributedString.Key.font, value: UIFont(name: "GothamPro-Light", size: 16)!, range: NSRange.init(location: 0, length: attributesStr.length))
