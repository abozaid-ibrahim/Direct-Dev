...
private final class CombineLatestCollectionTypeSink<C: Collection, O: ObserverType>
...
private final class CombineLatestCollectionType<C: Collection, R>: Producer<R> where C.Iterator.Element: ObservableConvertibleType {
